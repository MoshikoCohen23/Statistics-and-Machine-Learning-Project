...
# Predict the probabilities on your test set
...
# Ensure 'predicted' is a factor with the same levels as 'test_data$Grade'
levels(predicted) <- levels(test_data$Grade)

# Check the levels of 'predicted' and 'test_data$Grade'
